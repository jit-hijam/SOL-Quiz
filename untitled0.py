...
st.set_page_config(page_title="SOL Brand Quiz", page_icon="🎉", layout="centered")
st.title("🎉 Global Exhibition Day 2025 - SOL Brand Quiz")
st.markdown("Answer fast, earn more points! Each question has a 20-second timer. 🎯")
...
questions = [
    ("Which brand’s booth is this?", ["Brand A", "Brand B", "Brand C", "Brand D"], "Brand B", "images/booth1.jpg"),
...
if q_index < len(questions):
    ...
    st.balloons()
    st.success("Thanks for playing the SOL Brand Quiz! 🥳")
